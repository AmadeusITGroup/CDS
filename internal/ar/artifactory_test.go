...
const (
	...
	devenvGenericProdStorageResponse = `{
		...
		"uri" : "https://repository.rnd.fix.me:443/artifactory/api/storage/fix-me"
	  }`
...
var _ = ginkgo.Describe("net/artifactory", func() {
	ginkgo.Describe("Using AR token", func() {
		...
		ginkgo.BeforeEach(func() {
			...
			httpmock.RegisterResponder("GET", fmt.Sprintf("%v/api/storage/fix-me", artifactoryUrl), func(r *http.Request) (*http.Response, error) {
